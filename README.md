...
The .ehm file is useful if you wish to import the full league structure (including schedules) into an EHM database. These can be imported using the EHM Editor by archibalduk - https://www.ehmtheblueline.com/editor
